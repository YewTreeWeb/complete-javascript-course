...
let lastDice
let secondDice = document.getElementById('secondDice') // Add new variables to instructor

const game = document.querySelector('.wrapper') // Add new variables to instructor

// Create element with JS instead of HTML like instructor
if (!secondDice) {
